...
_hidden = ["catalog", "grid", "thumbcache", "viewer", "slideshow", "peek",
           "inspector",
           # librarystate/cli/sidebar (fauxcasa-4tu): persistence readers/
           # writers, argument-parsing/CLI-subcommand code, and the folder-
           # tree/albums sidebar split out of main.py, named here like their
           # siblings above/below even though main.py imports all three
           # directly at module top.
           "librarystate", "cli", "sidebar",
