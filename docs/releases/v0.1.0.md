...
- **Not shown yet**: photos in Apple's HEIC/HEIF format (what recent
  iPhones save by default) do not appear in Fauxcasa yet. Those files
  are left exactly as they are on disk, nothing is altered or lost, and
  support is planned.
